...
export class Kalaha__stateResult {
...
export class Kalaha extends ethereum.SmartContract {
  static bind(address: Address): Kalaha {
    return new Kalaha("Kalaha", address);
  }
  ...
  state(_game: BigInt): Kalaha__stateResult {
    ...
    return new Kalaha__stateResult(
  ...
  try_state(_game: BigInt): ethereum.CallResult<Kalaha__stateResult> {
